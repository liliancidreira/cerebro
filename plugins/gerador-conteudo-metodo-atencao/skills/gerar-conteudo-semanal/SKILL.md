---
name: gerar-conteudo-semanal
description: Gera conteúdo semanal completo usando o Método Atenção Digital de Elias Maman — pesquisa temas, define estratégia, escreve roteiros e legendas, revisa tudo. Use sempre que a Lilian pedir para gerar conteúdos da semana, criar o pack semanal, ou qualquer variação de "gera os conteúdos", "conteúdo dessa semana", "monta o pack".
---
...
**Importante**: Este passo só se aplica a Reels. Carrosseis e Posts de Texto seguem direto para o Passo 5.

### PASSO 5: Revisão Criativa (skill: revisor-gatilhos)

Ativar a skill `revisor-gatilhos` para cada peça gerada (Reels já validados estruturalmente + Carrosseis + Posts).
...
- O fluxo é sequencial: Temas → Estratégia → Geração → Revisão Estrutural (Reels) → Revisão Criativa → Aprovação
